...
if __name__ == '__main__':
    ...
    # for char_name in ["VA"]:
        ...
        for file_num, raw_file in enumerate(raw_files):
            ...
            cv.imwrite(f"transformed_char1_data/{char_name}/{file_num+1}.jpg", mono_image)
            num_samples += 1
            ...
            #                 cv.imwrite(f"transformed_char1_data/{char_name}/{file_num+1}_{xcrop}_{ycrop}_{ksizex}_{ksizey}.jpg", mono_image)
            #                 num_samples += 1
